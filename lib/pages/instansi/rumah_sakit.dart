...
class _HospitalPageState extends State<HospitalPage> {
  ...
  Future<List<dataInstansi>> getHospital() async {
    ...
    var response = await http.get(
        Uri.parse(baseUrl + 'institution?lat=$lat&long=$long&type=RS&size=10'),
    ...
    return Scaffold(
      ...
      appBar: AppBar(
       leading: IconButton(
        ...
        centerTitle: true,
        title: Text('RUMAH SAKIT',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.grey[900])),
      ),
