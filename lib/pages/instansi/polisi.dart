...
class _PolicePageState extends State<PolicePage> {
  ...
  Future<List<dataInstansi>> getPolice() async {
    ...
    var response = await http.get(
        Uri.parse(baseUrl + 'institution?lat=$lat&long=$long&type=P&size=10'),
    ...
    return Scaffold(
      ...
      appBar: AppBar(
       leading: IconButton(
        ...
        centerTitle: true,
        title: Text('POLISI',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.grey[900])),
      ),
